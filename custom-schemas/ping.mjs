const schema = {
	...
	routes: {
		ping: {
			...
			parameters: [],
			tests: [],
			modifiers: [{ phase: "execute", handlerName: "respondWithPong" }],
		},
		echo: {
			requestMethod: "GET",
			...
			tests: [],
			modifiers: [{ phase: "execute", handlerName: "responseWithEcho" }],
		},
		add: {
			requestMethod: "GET",
			...
			parameters: [
				{
					position: { key: "a", value: "{{USER_PARAM}}", location: "insert" },
					z: { primitive: "number()", options: [] },
				},
				{
					position: { key: "b", value: "{{USER_PARAM}}", location: "insert" },
					z: { primitive: "number()", options: [] },
				},
			],
			tests: [],
			modifiers: [{ phase: "execute", handlerName: "respondAddNumbers" }],
		},
	},
	handlers: {
